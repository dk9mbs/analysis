...
def execute(params={}):
    ...
    df_hour['restapi_sunshine_duration']=np.where(df_hour["diff"] >= 0.8, 1, 0)
    ...
    df_hour['dwd_sunshine_duration']=np.where(df_hour["dwd_sunshine_duration"] <= 0, 0, df_hour["dwd_sunshine_duration"] / 60)
